...
**Step 1: Acquire the Sentinel DeFi Earth Access NFT**
...
[COMPONENT:STEP_BLOCK]
{
  ...
  "steps": [
    ...
    "Visit the official Sentinel DeFi Earth Access NFT page",
...
3. **Purchase**: Acquire the Sentinel DeFi Earth Access NFT
            ...
            questions: [
              {
                ...
                options: [
                  ...
                  "The Sentinel DeFi Earth Access NFT and wallet whitelisting",
                  "A monthly subscription payment",
                  "KYC verification documents"
                ],
                correctAnswers: [1],
                explanation: "Access to the Sentinel DeFi vault requires purchasing the Sentinel DeFi Earth Access NFT and waiting for your wallet to be whitelisted (up to 7 days).",
                points: 10
              },
              {
                id: "q5-5-2",
